...
class FoodHomeTabPage extends StatefulWidget {
  ...
  const FoodHomeTabPage({super.key, required this.customerEmail});
...
class _FoodHomeTabPageState extends State<FoodHomeTabPage> {
  ...
  final _cartService = CartService.ofCategory('food');
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Restoranları görmek için önce adres seç.',
        ...
        builder: (context, selected, _) {
          ...
          return FutureBuilder<List<dynamic>>(
            ...
            builder: (context, snapshot) {
              ...
              if (list.isEmpty) {
                return const Center(
                  child: Text('Seçili adres için restoran bulunamadı.'),
                );
              }
